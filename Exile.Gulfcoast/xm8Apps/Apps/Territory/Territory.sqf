...
_playerUID = getPlayerUID player;
{
	...
	_buildRights = _flag getVariable ["ExileTerritoryBuildRights", []];
		if (_playerUID in _buildRights) then
		{
			...
			_allowedParts = 0;
			switch(_level)do{
				case 1:{_allowedParts = 10;};
				case 2:{_allowedParts = 15;};
				case 3:{_allowedParts = 20;};
				case 4:{_allowedParts = 30;};
				case 5:{_allowedParts = 40;};
				case 6:{_allowedParts = 60;};
				case 7:{_allowedParts = 70;};
				case 8:{_allowedParts = 80;};
				case 9:{_allowedParts = 90;};
				case 10:{_allowedParts = 100;};
...
fnc_goBack = {
  _display = uiNameSpace getVariable ["RscExileXM8", displayNull];
  _Ctrls = [1116,866,865,864,863,862,861,860];
  {
